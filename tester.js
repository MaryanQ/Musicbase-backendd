...
async function GetArtists() {
  const response = await fetch(`http://localhost:3302/artists`);
...
async function GetAlbums() {
  const response = await fetch(`http://localhost:3302/albums`);
...
async function GetTracks() {
  const response = await fetch(`http://localhost:3302/tracks`);
